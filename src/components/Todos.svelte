        ...
        <div class="text-blue-500">
            {#if isSaving}
                <svg class="w-4 h-4 fill-current" viewBox="0 0 20 20">
                    <path
                        d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98
                        4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1z" />
                </svg>
            {/if}
        </div>
    </div>
            ...
            <div class="px-3">
                <form on:submit|preventDefault={createTodo}>
                    <input
                        ...
                        class="block w-full px-3 py-2 placeholder-gray-500 bg-white rounded shadow
                        focus:outline-none" />
                </form>
            </div>
